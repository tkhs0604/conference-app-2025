 ...
 * Reason: Required to compile [IOSLifecycleOwner].
 * Changes:
 *   - Change the package to io.github.droidkaigi.confsched.interop.
 *   - Add the required opt-in for the experimental API to compile or suppress warnings.
 */
